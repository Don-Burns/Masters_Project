...
% 10 \% predicted under Roff 1983
	...
	As can be seen in Figure \ref{growth_curve}, growth is very fast within the model.  Asymptotic mass is reached by ~10 days.  This makes interpreting any results regarding maturation time difficult % TODO < rephrase
...
%		TODO 1.The title for each plot needs to be cleaned up.  2.The units should be m^2 and 3.need letter labels for each.
		\includegraphics[width=\textwidth]{../../results/report_3D2D_HighLowResCLEAN.pdf}
...
\section{Discussion}
	...
	- higher metabolic cost are leading to hyper allometry, even though I am seeing this for what the data considers too high \parencite{Marshall2019} % see my google drive doc
